import 'package:custompainter6/background_painter.dart';
import 'package:custompainter6/constants/const.dart';
import 'package:custompainter6/modals/brush.dart';
import 'package:custompainter6/modals/canvas.dart';
import 'package:custompainter6/modals/toolbar.dart';
import 'package:custompainter6/utils.dart';
import 'package:custompainter6/widgets/color_selector.dart';
    ...
    return SingleChildScrollView(
      child: Column(
        ...
        children: [
          ...
          Consumer<CanvasNotifier>(
              builder: (context, CanvasNotifier _tool, Widget? child) {
            final length = _tool.listOfColors.length > noOfRecentColors
                ? noOfRecentColors
                : _tool.listOfColors.length;
            return SizedBox(
              ...
              child: ListView.builder(
                ...
                itemCount: length,
                itemBuilder: (context, index) {
                  final recents = _tool.listOfColors;
                  return InkWell(
                    onTap: () {
